...
const RegisterPage: React.FC = () => {
  ...
  const { register, loginWithProvider, isLoggedIn } = useAuth();
  ...
  const handleSocialRegistration = async (provider: 'google' | 'apple' | 'microsoft') => {
    setError(null);
    setIsSubmitting(true);
    ...
    try {
      ...
      setError(error.message || `Registration with ${provider} failed. Please try again.`);
    } finally {
      setIsSubmitting(false);
    }
  };
