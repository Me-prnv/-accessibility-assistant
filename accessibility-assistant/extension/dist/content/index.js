...
let visualAssistant = null;
let motorAssistant = null;
let cognitiveAssistant = null;
// UI Elements
...
function cleanup() {
    ...
    document.documentElement.classList.remove(`${ASSISTANT_CLASS_PREFIX}high-contrast`, `${ASSISTANT_CLASS_PREFIX}simplified-mode`);
    // Reset zoom
...
export { readTextAloud, toggleHighContrast, summarizePage, toggleSimplifiedView };
