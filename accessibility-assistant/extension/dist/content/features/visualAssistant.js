...
export function createVisualAssistant(options = {}) {
    ...
    `;
        ...
        document.getElementById('accessibility-assistant-high-contrast')?.addEventListener('change', (e) => {
            settings.enableHighContrast = e.target.checked;
        });
        document.getElementById('accessibility-assistant-color-blind')?.addEventListener('change', (e) => {
            settings.enableColorBlindMode = e.target.checked;
            const colorBlindTypeSelect = document.getElementById('accessibility-assistant-color-blind-type');
        ...
        document.getElementById('accessibility-assistant-color-blind-type')?.addEventListener('change', (e) => {
            settings.colorBlindType = e.target.value;
        });
        ...
        document.getElementById('accessibility-assistant-char-spacing')?.addEventListener('input', (e) => {
            settings.characterSpacing = parseFloat(e.target.value);
        ...
        document.getElementById('accessibility-assistant-zoom')?.addEventListener('input', (e) => {
            settings.zoomLevel = parseFloat(e.target.value);
    ...
    function updateControlPanel() {
        const highContrastCheckbox = document.getElementById('accessibility-assistant-high-contrast');
        if (highContrastCheckbox) {
            highContrastCheckbox.checked = settings.enableHighContrast;
        }
        const colorBlindCheckbox = document.getElementById('accessibility-assistant-color-blind');
        ...
        const fontFamilySelect = document.getElementById('accessibility-assistant-font-family');
        if (fontFamilySelect) {
            fontFamilySelect.value = settings.fontFamily;
        }
        const fontSizeInput = document.getElementById('accessibility-assistant-font-size');
        if (fontSizeInput) {
        ...
        const lineSpacingInput = document.getElementById('accessibility-assistant-line-spacing');
        if (lineSpacingInput) {
        ...
        const charSpacingInput = document.getElementById('accessibility-assistant-char-spacing');
        if (charSpacingInput) {
        ...
        const zoomInput = document.getElementById('accessibility-assistant-zoom');
        if (zoomInput) {
