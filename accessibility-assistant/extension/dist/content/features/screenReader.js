...
export function createScreenReader(options = {}) {
    ...
    function updateVoiceSelector() {
        const voiceSelector = document.getElementById('accessibility-assistant-screen-reader-voice');
        if (voiceSelector) {
    ...
    function updateControlPanel() {
        const rateSlider = document.getElementById('accessibility-assistant-screen-reader-rate');
        if (rateSlider) {
        ...
        const pitchSlider = document.getElementById('accessibility-assistant-screen-reader-pitch');
        if (pitchSlider) {
        ...
        const volumeSlider = document.getElementById('accessibility-assistant-screen-reader-volume');
        if (volumeSlider) {
