...
export function createAccessibilityManager() {
    ...
    `;
        ...
        const visualSection = createFeatureSection('visual', 'Visual Accessibility', 'Adjust contrast, colors, fonts, and other visual elements', [
            {
                id: 'high-contrast',
        ...
        const screenReaderSection = createFeatureSection('screenReader', 'Screen Reader', 'Navigation assistance and text-to-speech functionality', [
            {
        ...
        // Cognitive section
        const cognitiveSection = createFeatureSection('cognitive', 'Cognitive Assistance', 'Reading aids and focus assistance', [
            {
        ...
        // Motor section
        const motorSection = createFeatureSection('motor', 'Motor Assistance', 'Help with mouse and keyboard input', [
            {
                id: 'motor-enabled',
        ...
        const speechSection = createFeatureSection('speech', 'Speech Recognition', 'Control the browser using voice commands', [
            {
                id: 'speech-enabled',
    ...
    function createFeatureSection(id, title, description, toggles, dropdowns) {
    ...
    function updateControlPanel() {
        if (!controlPanel)
            return;
        // Update main toggle
        const mainToggle = document.getElementById('accessibility-main-toggle');
        if (mainToggle) {
    ...
    function cleanup() {
        ...
        if (assistants.visual)
            assistants.visual.cleanup();
        if (assistants.screenReader)
            assistants.screenReader.cleanup();
        if (assistants.cognitive)
            assistants.cognitive.cleanup();
        if (assistants.motor)
            assistants.motor.cleanup();
        if (assistants.speech)
            assistants.speech.cleanup();
        // Remove UI elements
