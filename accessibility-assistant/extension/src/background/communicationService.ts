...
export enum MessageType {
  ...
  APPLY_ACCESSIBILITY_FEATURES = 'APPLY_ACCESSIBILITY_FEATURES',
...
// Response interface for all message handlers
 ...
 */
export const initCommunicationService = (): void => {
 ...
 */
const handleSyncSettings = async (payload: any): Promise<MessageResponse> => {
  try {
 ...
 */
const handleSyncStats = async (payload: any): Promise<MessageResponse> => {
  try {
 ...
 * @returns Promise resolving to success response
 */
const handleApplySettings = async (payload: any, tabId?: number): Promise<MessageResponse> => {
  try {
    const { settings } = payload;
 ...
 */
const handleGetWebsitePreferences = async (payload: any): Promise<MessageResponse> => {
  try {
 ...
 * @returns Promise resolving to success response
 */
const handleSetWebsitePreferences = async (payload: any): Promise<MessageResponse> => {
  try {
 ...
 * @returns Promise resolving to success response
 */
const handleFeatureUsed = async (payload: any): Promise<MessageResponse> => {
  try {
 ...
 */
const handleRequestSettings = async (payload: any, tabId?: number): Promise<MessageResponse> => {
  try {
    const { url } = payload;
 ...
 */
const handlePageLoaded = async (payload: any, port: chrome.runtime.Port): void => {
  try {
 ...
 */
const handleFeatureActivated = async (payload: any): Promise<void> => {
  try {
 ...
 * @param payload Feature info payload
 */
const handleFeatureDeactivated = async (payload: any): Promise<void> => {
 ...
 * @returns Promise resolving to success response
 */
const handleUpdateStatistics = async (payload: any): Promise<MessageResponse> => {
  try {
 ...
 */
const handleLogError = (payload: any): void => {
 ...
 */
export const setActiveUser = async (userId: string): Promise<boolean> => {
  try {
